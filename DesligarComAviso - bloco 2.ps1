# ==============================================================================
# SISTEMA DE DESLIGAMENTO AUTOMÁTICO - VERSÃO FINAL - BLOCO 2
...
$CaminhoLista = "C:\Monitora\maquinas2.txt"

$DataHoje = Get-Date -Format "dd-MM-yyyy_HHmm"
$ArquivoRelatorio = "C:\Monitora\Relatorio_Final_bloco2_$DataHoje.txt"
